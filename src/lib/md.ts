...
function figure(src: string) {
  // Khung an toàn full chiều rộng, cao tối đa 500px, hiển thị ĐẦY ĐỦ ảnh (không cắt).
  return `<figure class="my-6"><img src="${src}" alt="" loading="lazy" class="w-full max-h-[500px] object-contain rounded-card border border-border bg-bg-soft" /></figure>`;
}
