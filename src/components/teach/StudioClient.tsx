            ...
            <div className="space-y-3">
              ...
              <details className="border border-border rounded-lg p-3">
                ...
                <div className="space-y-2 mt-3">
                  ...
                  <div><label className="block text-[11px] text-ink-3 mb-1">📸 Ảnh/Video kết quả học viên khóa trước (bằng chứng tăng chuyển đổi)</label><GalleryUpload value={form.result_images} onChange={(u) => setForm({ ...form, result_images: u })} /></div>
