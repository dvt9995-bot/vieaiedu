  ...
  return (
    <section className="rounded-card border border-border bg-surface p-6">
      ...
      {orders === null ? <p className="text-ink-3 text-sm">Đang tải…</p>
        : orders.length === 0 ? <p className="text-ink-3 text-sm">Bạn chưa có đơn hàng nào.</p>
        : (
