...
export const metadata: Metadata = {
  title: "Blog — Tin tức & kiến thức AI",
...
export default async function BlogPage() {
  ...
  return (
    <div className="container-x py-12">
      ...
      <p className="text-ink-2 text-lg mb-10 max-w-[60ch]">Tin AI nổi bật mỗi ngày, hướng dẫn và kinh nghiệm thực chiến.</p>
      <div className="grid gap-6 md:grid-cols-3">
        {posts.map((b) => (
          <Link key={b.slug} href={`/blog/${b.slug}`} className="block rounded-card border border-border bg-surface overflow-hidden transition-all hover:border-border-strong hover:shadow-soft hover:-translate-y-1">
            <div className="aspect-video bg-bg-soft border-b border-border flex items-center justify-center overflow-hidden">
              {b.cover ? (
            ...
            <div className="p-5">
              ...
              <h2 className="text-lg font-bold tracking-tight mb-2 line-clamp-2">{b.title}</h2>
